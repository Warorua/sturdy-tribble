<?php
   ...
   $data['bill_to_address_line1'] = null;
   $data['bill_to_address_city'] = null;
   $data['bill_to_address_state'] = null;
   $data['bill_to_address_postal_code'] = null;
   $data['bill_to_address_country'] = null;
